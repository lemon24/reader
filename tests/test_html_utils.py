...
STRIP_HTML_DATA = [
    ...
    ('aa<script>ss</script>bb', 'aabb'),
    ('aa<noscript>ss</noscript>bb', 'aabb'),
    ('aa<style>ss</style>bb', 'aabb'),
    ('aa<title>tt</title>bb', 'aabb'),
    ('<head><script>ss</script></head>bb', 'bb'),
    ('<head><noscript>ss</noscript>bb', 'bb'),
    ('<head><style>ss</style></head>bb', 'bb'),
    ('<head><title>tt</title>bb', 'bb'),
    ('<head>aa<script>ss</script>bb', 'aabb'),
    ('<head>aa<noscript>ss</noscript></head>bb', 'aabb'),
    ('<head>aa<style>ss</style>bb', 'aabb'),
    ('<head>aa<title>tt</title></head>bb', 'aabb'),
    (
        """
        <head>
            aa
    ...
    ('aa<img alt="x"/>bb', 'aaxbb'),
    ('aa<img alt="x" title="y"/>bb', 'aaxybb'),
    ('<a alt="x" title="t">aa</a>', 'aat'),
